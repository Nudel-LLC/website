...
import { outfit, playfairDisplay, notoSansJP, notoSerifJP, syncopate } from "@/lib/fonts";
...
export default function RootLayout({
  ...
  return (
    <html lang="ja">
      ...
      <body
        className={`${outfit.variable} ${playfairDisplay.variable} ${notoSansJP.variable} ${notoSerifJP.variable} ${syncopate.variable} antialiased`}
      >
